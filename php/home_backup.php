...
<body>
  <header>
    ...
    <div class="labarContainer">
      ...
      <input type="range" orient=vertical id="range" min="0" max="10" value="2" step="1" oninput="getValue()">
    </div>
    ...
    <form class="search">
      ...
      <div class="storeContainer">
        ...
        <ul class="storeUl">
          ...
          ?>
          <li>
            <input type='button' value='全選' id='store12' class='store12'>
          </li>"
        </ul>
        <a id="next1">
          <i class="fas fa-chevron-right"></i>
